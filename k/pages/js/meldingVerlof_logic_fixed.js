// js/meldingVerlof_logic_fixed.js
...
async function initializeVerlofModalForm(geselecteerdeDatum, medewerkerContext, itemData = null) {
    ...
    // --- Vul medewerkerinformatie automatisch in ---
    ...
    // Vul de velden ALTIJD in met de beschikbare informatie
    console.log('[MeldingVerlof] === INVULLEN VAN VELDEN ===');
    console.log('[MeldingVerlof] Te gebruiken waarden:', { displayName, medewerkerId });
    
    if (medewerkerDisplayVeld) {
        medewerkerDisplayVeld.value = displayName || 'Onbekende gebruiker';
        console.log('[MeldingVerlof] ✓ ModalMedewerkerDisplay ingevuld:', medewerkerDisplayVeld.value);
    } else {
        console.error('[MeldingVerlof] ✗ ModalMedewerkerDisplay veld niet gevonden!');
    }
    ...
    if (medewerkerIdDisplayVeld) {
        ...
        console.error('[MeldingVerlof] ✗ ModalMedewerkerIDDisplay veld niet gevonden!');
    }
    ...
    if (verborgenMedewerkerIdVeld) {
        ...
        console.error('[MeldingVerlof] ✗ MedewerkerID hidden field niet gevonden!');
    }
...
console.log("Rooster/pages/js/meldingVerlof_logic_fixed.js geladen - verlofvelden automatische invulling geïmplementeerd.");
